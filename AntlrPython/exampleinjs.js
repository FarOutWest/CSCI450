  ...
  for (var o = 0; o < objects.length; o++) {
    ...
    for (var i = 0; i < match.length; i++) {
      try {
        ...
        //TODO: OPTIMIZE: Check if the vertix is alredy in the array, if it is just reuse the index
        vertices.push(v1);
        vertices.push(v2);
        vertices.push(v3);
...
function saveResult(vertices, triangles) {
  ...
  document.getElementById('conversion').innerText = 'Conversion complete - Click the download link to download you OpenSCAD file! Total Triangels: ' + triangles.length;
}
